...
export default function WhatsAppButton() {
  ...
  const message = encodeURIComponent('Hello Credify! I would like to know more about your background verification and KYC/KYB API services. Could you please share the details?')
  ...
  return (
    <a
      ...
      className="fixed bottom-26 right-6 z-50 group"
