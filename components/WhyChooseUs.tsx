...
const gridFeatures = [
  {
    ...
    description: 'Delivering dependable background verification services backed by real industry knowledge and processes that adapt to changing workforce needs.',
    color: 'text-blue-600',
    bg: 'bg-blue-50',
  ...
  },
  {
    ...
    description: 'Employee checks, vendor verification, document checks, and due diligence — all from one experienced partner.',
    color: 'text-amber-600',
    bg: 'bg-amber-50',
    accentLine: 'bg-amber-400',
  },
  {
    icon: '/icons/tailored-verification-programs.svg',
    title: 'Tailored Verification Programs',
    description: 'We customize checks based on your industry, hiring policies, team size, and business goals so everything fits your actual needs.',
  ...
  },
  {
    ...
    description: 'Technology-enabled workflows and experienced professionals deliver accurate reports within optimized timelines without compromising quality.',
    color: 'text-orange-600',
    bg: 'bg-orange-50',
    accentLine: 'bg-orange-400',
  },
  {
    ...
    description: 'Established protocols and quality checks ensure all reports are comprehensive, accurate, and valuable.',
    color: 'text-sky-600',
    bg: 'bg-sky-50',
  ...
  },
  {
    ...
    title: 'Technology-Driven Verification',
    description: 'Digital forms, easy tracking, secure delivery, and real-time updates make managing requests hassle-free.',
    color: 'text-blue-600',
    bg: 'bg-blue-50',
    accentLine: 'bg-blue-400',
  },
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            Why Choose Credify for Background Verification Services?
          </motion.h2>
          ...
          >
            Credify is a reliable Background Verification Services partner, enabling businesses to hire confidently while ensuring secure, accurate, and compliant background checks.
          </motion.p>
          ...
          >
            We have completed millions of checks, hold strong international certifications, and have been in operation for nearly 10 years, providing reliable services that reduce hiring risk, enhance team quality, and assist in making informed business decisions across various industries.
          </motion.p>
        </div>

        {/* ─── Hero feature cards — 2 side by side ─── */}
