...
export const metadata: Metadata = {
  ...
  description:
    'Support a safe and productive workplace with Credify India’s Employee Drug Screening Verification Services. ISO 27001, ISO 9001 certified and DPDP Ready partner.',
  alternates: {
