...
export default function EduClient() {
  ...
  return (
    <div className="bg-white text-slate-900 overflow-hidden">
      ...
      <section className="relative pt-28 md:pt-36 pb-12 md:pb-16 bg-gradient-to-b from-purple-50/70 via-white to-slate-50/50 border-b border-slate-100">
