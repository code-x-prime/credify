...
export const metadata: Metadata = {
  ...
  description:
    'Make smart hiring choices with Credify India’s employee credit check services. ISO 27001, ISO 9001 certified and DPDP Ready partner.',
  alternates: {
    canonical: '/credit-check-verification',
  },
}
