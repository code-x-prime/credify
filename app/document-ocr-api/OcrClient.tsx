...
const whyChooseUs = [
  {
    ...
    description: 'Built on ISO 27001 and ISO 9001 certified operational practices, and DPDP Ready data handling for secure and reliable document processing.',
...
const ocrFaqs: FAQItem[] = [
  ...
  },
  {
    ...
    a: 'Yes. Credify India’s API platform follows ISO 27001 and ISO 9001 certified operational standards, and DPDP Ready data handling to support secure document processing and protect sensitive information.',
  },
  {
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 flex items-start gap-4">
                ...
                <div className="text-xs sm:text-sm text-slate-600">
                  ...
                  Credify India is ISO 27001 and ISO 9001 certified, and DPDP Ready. Clear information security, quality management, and everyday operation standards are observed based on international standards.
                </div>
              </div>
            </div>
